...
/* ─────────────────────────────────────────────────────────────
   HomepageNavbar
   Used ONLY on src/app/page.jsx (the marketing homepage).
   All other pages use the shared Navbar.jsx.

   Desktop: transparent floating bar — logo left, anchor links
   centred, auth/CTA right.
...
export default function HomepageNavbar() {
  ...
  /* ── Scroll — crossfades from invisible to frosted ── */
  useEffect(() => {
  ...
  /* When scrolled, show a frosted pill exactly like the app Navbar.
     When not scrolled, completely transparent — hero shines through. */
    ...
    <>
      ...
      >
        ...
        >
          {[
            ...
            <span key={i} style={{
              ...
              transition: "all 0.25s cubic-bezier(0.4,0,0.2,1)", ...s,
            }} />
          ))}
        </button>
        ...
        >
          ...
          {/* All links in mobile: marketing + app */}
          <div style={{ flex: 1 }}>
            {/* Marketing section */}
            <p style={{
              ...
              opacity: menuOpen ? 1 : 0, transition: "opacity 0.3s ease", transitionDelay: "40ms",
            }}>
              Explore
            </p>
            ...
            <p style={{
              fontFamily: "var(--font-display)", fontSize: "0.5rem",
              letterSpacing: "0.2em", textTransform: "uppercase",
              color: "rgba(255,255,255,0.2)", marginTop: 20, marginBottom: 6,
