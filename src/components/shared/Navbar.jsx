  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Logo ───────────────────────────────────────────
            Uses the Image logo when available, falls back to
            text wordmark so the nav never breaks if the file
            hasn't been added to /public/images yet.         */}
        <Link href="/" style={{ textDecoration: "none", zIndex: 10, display: "flex", alignItems: "center" }}>
          <Image
            ...
            style={{
              ...
              width:          "auto",
              maxWidth:       "120px",
              mixBlendMode:   "screen",   // black pixels become invisible
            }}
            onError={(e) => {
          ...
          {user ? (
            ...
            >
              ...
              >
                <button
                  className="kairos-btn-primary"
                  style={{ fontSize: "1rem", padding: "1rem 2rem", width: "100%", minHeight: "44px" }}
                >
                  Begin Journey
                </button>
              </Link>
