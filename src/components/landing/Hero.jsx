  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      particlesRef.current.forEach((p) => {
        ...
        // Soft halo on larger gold particles
      ...
      >
        ...
        <p
          ...
          style={{
            ...
            transition: `opacity 0.6s var(--ease-divine) 0.1s,
                         transform 0.6s var(--ease-divine) 0.1s`,
          }}
        >
        ...
        <h1
          ...
          style={{
            ...
            transition: `opacity 0.8s var(--ease-divine) 0.2s,
                         transform 0.8s var(--ease-divine) 0.2s,
                         filter 0.8s var(--ease-divine) 0.2s`,
          }}
        >
          KAIROS
        </h1>
        ...
        <p
          ...
          style={{
            ...
            transition:  `opacity 0.8s var(--ease-divine) 0.35s,
                          transform 0.8s var(--ease-divine) 0.35s`,
          }}
        >
        ...
        <div
          style={{
            ...
            opacity:        visible ? 1 : 0,
            transform:      visible ? "translateY(0)" : "translateY(12px)",
            transition:    `opacity 0.8s var(--ease-divine) 0.5s,
                            transform 0.8s var(--ease-divine) 0.5s`,
          }}
        >
          <button className="kairos-btn-primary">
            Begin Your Journey
          </button>
          <button className="kairos-btn-secondary">
            Learn More
          </button>
        </div>
